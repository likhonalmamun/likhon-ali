...
const Footer = () => {
  return (
    <div className="mt-32 rounded-2xl p-10 text-center border-t-2 border-amber-300">
      ...
      <div className="flex text-teal-300 font-bold justify-center items-center gap-7 mt-3 mx-auto">
